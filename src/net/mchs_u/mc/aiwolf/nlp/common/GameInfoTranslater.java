...
public class GameInfoTranslater extends GameInfo {
	...
	public List<Talk> getTalkList() {
		...
		for(Talk t: gameInfo.getTalkList())
			ret.add(new Talk(t.getIdx(), t.getDay(), t.getTurn(), t.getAgent(), naturalLanguageToProtocol.toProtocolForTalk(this, t.getAgent(), t.getText())));
		return ret;
	}
	...
	public List<Talk> getWhisperList() {
		...
		for(Talk t: gameInfo.getWhisperList())
			ret.add(new Talk(t.getIdx(), t.getDay(), t.getTurn(), t.getAgent(), naturalLanguageToProtocol.toProtocolForWhisper(this, t.getAgent(), t.getText())));
		return ret;
	}
